...
@section('contenido')
    ...
    <form action="/productos/update" method="post">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="rela_marcas" class="form-control" id="rela_marcas" value="{{ $producto->rela_marcas }}" required>
        </div>

        <div class="form-group mb-3">
            <label for="rela_medidas">Medida (ID)</label>
            <input type="number" name="rela_medidas" class="form-control" id="rela_medidas" value="{{ $producto->rela_medidas }}" required>
        </div>

        <div class="form-group mb-3">
            <label for="rela_rubro">Rubro (ID)</label>
            <input type="number" name="rela_rubro" class="form-control" id="rela_rubro" value="{{ $producto->rela_rubro }}" required>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="rela_proveedor" class="form-control" id="rela_proveedor" value="{{ $producto->rela_proveedor }}" required>
        </div>
